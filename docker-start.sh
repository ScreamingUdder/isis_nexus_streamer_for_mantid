...
nexus_producer/main_nexusPublisher -f ${NEXUS_FILE_NAME} -b ${KAFKA_BROKER_NAME} -t ${INSTRUMENT_NAME}_events -r ${INSTRUMENT_NAME}_runInfo -a ${INSTRUMENT_NAME}_detSpecMap -d ${DETSPECMAP_FILE_NAME} -z
